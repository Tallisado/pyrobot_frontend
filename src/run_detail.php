...
if($action == "setsuccess" && $test_id != "" && $test_version != "" && $test_version != "-1" && $run_id != "" && $success != "") {
	...
	if($todel_id == $run_id) {
		header("location: testsuite_detail.php?id=$test_id&version=$version");
		die();
	}
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><a href="testsuites.php" class="breadcumbs">Tests overview </a> <strong>&raquo;</strong> <a href="testsuite_detail.php?version=<? echo $test_version; ?>&id=<? echo $test_id; ?>" class="breadcumbs">modify test (<? echo  $tRow->name; ?> / version <? echo $test_version; ?>) </a> <strong>&raquo;</strong> <a href="" class="breadcumbs">show run (<? echo  $rRow->timestamp; ?>) </a> </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td valign="top"><table cellpadding="3" cellspacing="2" border="0" class="datatable_noclick">
		...
		while($rcRow = mysql_fetch_object($rcRes)) {
    ...
    <br>
      <table border="0" cellspacing="2" cellpadding="3" class="datatable">
		...
		<?
		$even = true;
		while($runsRow = mysql_fetch_object($runsRes)) {
			if($even) $bgcol = "#EEEEEE";
			else $bgcol = "#DDDDDD";
			?>
