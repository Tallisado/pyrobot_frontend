...
<script language="javascript" type="text/javascript">
	function delTest(id, name) {
		var check = window.confirm("Are you sure you want to remove the entire suite ("+name+")?");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><a href="testsuites.php" class="breadcumbs">Test Suite Overview</a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><? if($admin) { ?><a href="testsuite_detail.php?action=new">&raquo; create new suite <img src="pix/new.gif" width="14" height="14" border="0" alt="view"></a><? } ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
	...
	<tr style="background-color:<? echo $bgcol; ?>;" onMouseOver="this.style.background='#B9FAFD'" onMouseOut="this.style.background='<? echo $bgcol; ?>'">
		<td onClick="location.href='testsuite_detail.php?version=-1&id=<? echo $row->id; ?>'"><? echo $row->name; ?></td>
		<td onClick="location.href='testsuite_detail.php?version=-1&id=<? echo $row->id; ?>'"><? echo shorten($row->description, 40); ?></td>
		<td align="center" onClick="location.href='testsuite_detail.php?version=-1&id=<? echo $row->id; ?>'"><? echo $row->created; ?></td>
		<td align="center" onClick="location.href='testsuite_detail.php?version=-1&id=<? echo $row->id; ?>'"><? echo $row->last_modified; ?></td>
		<td align="center" onClick="location.href='testsuite_detail.php?version=-1&id=<? echo $row->id; ?>'"><? echo $row->run_count; ?></td>
		<? if($admin) { ?>
